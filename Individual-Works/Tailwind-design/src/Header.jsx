...
function Header(props) {
    return <div class="mt-4 text-center grid place-items-center">

        <h1 class="text-3xl font-bold">{props.headline}</h1>
        <p class="max-w-xs">{props.text}</p>
        <button type="button" class="mt-4 p-2 bg-red-600 text-white rounded-full ring-offset-4 ">{props.button}</button>
